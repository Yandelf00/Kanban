    ...
    return (
        <div className='mt-[2rem] h-full flex flex-col'>
            {tasks.map((tasks : taskType) => (
                <div className='mb-10 flex justify-start font-bold items-start text-[rgb(0,0,0)] dark:text-[rgba(255,255,255,255)] pr-1 pt-2 rounded-md pl-2 h-[7rem] w-[17rem] dark:bg-[rgba(43,44,55,255)] bg-[rgba(255,255,255,255)] ' key={tasks.title}>
                    {tasks.title}
                </div>
            ))}
        </div>
