            ...
            {isOpen ?
             (
                <>
                    ...
                    <div className='bg-white flex justify-center items-start pt-10 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[1100] dark:bg-[rgba(43,44,55,255)] min-h-[45rem] w-[35rem] rounded-md'>
                        <TaskForm/>
                    </div>
                </>
             )
